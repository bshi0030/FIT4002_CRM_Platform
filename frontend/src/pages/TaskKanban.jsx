...
import { Search, Bell, Building2, Calendar, Users, ChevronDown } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
...
//MOCK DATA (I will replace later with backend useEffect hook)
const TASKS = [
  ...
  return (
    <div className="task-container">
      ...
      <div className="task-navbar">
        ...
        {/* shadcn Select - Fixed trigger for congestion */}
            ...
            <div key={column.id} className="kanban-column">
              ...
              <div className="cards-stack">
                ...
                {filteredTasks.filter(t => t.status === column.id).length === 0 && (
                  <p className="text-xs text-gray-400 italic text-center mt-4">No tasks found</p>
                )}
              </div>
            </div>
          ))}
