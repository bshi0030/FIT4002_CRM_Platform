                      ...
                      {customers.map((cust) => (
                          <tr key={cust._id}>
                              <td>
                                  <Link to={`/customers/${cust._id}`} className="contact-cell">
                                      {cust.companyLogo ? (
                                          <img
                                              src={`${import.meta.env.VITE_API_URL || 'http://localhost:5001'}${cust.companyLogo}`}
                                              alt="logo" className="contact-avatar"/>
                                      ) : (
                        ...
                        <span style={{cursor: 'pointer'}} title="Email Customer" onClick={() => handleInteraction(cust, 'Email')}>✉️</span>
                                          ...
                                          <a href={`tel:${cust.phone}`}
                                             ...
                                             title="Call Customer" onClick={() => handleInteraction(cust, 'Call')}>📞</a>
                      </span>
                                  </div>
                              </td>
                          </tr>
