...
import { FiAlertCircle, FiCheckCircle, FiSettings, FiUser, FiUsers } from 'react-icons/fi';
...
// Admin-only settings. Hosts system settings, team management, and the user directory
  ...
  return (
    <div className="admin-page">
      <div className="admin-header">
        <div>
          <h1>Settings</h1>
          <p>System configuration, teams and user access — Admin only.</p>
        </div>
      </div>
